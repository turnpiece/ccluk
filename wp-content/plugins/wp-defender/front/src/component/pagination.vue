<template>
    <ul :class="containerClass" v-if="!noLiSurround">
        ...
        <li v-for="page in pages" :class="[pageClass, page.selected ? activeClass : '', page.disabled ? disabledClass : '', page.breakView ? breakViewClass: '']">
            ...
            <a v-else @click="handlePageSelected(page.index + 1)" @keyup.enter="handlePageSelected(page.index + 1)" :disabled="page.selected" :class="pageLinkClass" tabindex="0">{{ page.content }}</a>
        </li>
