...
export default {
    methods: {
        ...
        isWhitelabelEnabled: function () {
            return defender.whitelabel.enabled;
        },
        /**
         * show campaign URL from WPMUDEV
         * @param slug
         * @returns {string}
         */
         ...
         * @returns {string}
         */
        campaignUrl: function (path = '', slug = '') {
            return 'https://premium.wpmudev.org/' + path + '?utm_source=defender&utm_medium=plugin&utm_campaign=' + slug;
        },
        /**
         *
         * @param method
