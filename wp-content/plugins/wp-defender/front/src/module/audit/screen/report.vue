                    ...
                    <div class="sui-box-settings-col-2">
                        ...
                        <div class="sui-border-frame sui-toggle-content">
                            ...
                            <div class="sui-form-field margin-top-30 schedule-box">
                                <label for="audit_report_frequency"
                                       id="label_audit_report_frequency" class="sui-label">
                                    {{__("Frequency")}}
                                </label>
                                <div class="sui-row">
                                    <div class="sui-col">
                                        <select id="audit_report_frequency"
                                                aria-labelledby="label_audit_report_frequency" class="report-select"
                                                name="frequency" v-model="model.frequency">
                                ...
                                <div class="sui-row">
                                    <div class="sui-col days-container" v-show="state.show_day">
                                        <label for="audit_report_day_week"
                                               id="label_audit_report_day_week" class="sui-label">
                                            {{__("Day of the week")}}
                                        </label>
                                        <select id="audit_report_day_week"
                                                aria-labelledby="label_audit_report_day_week" class="report-select"
                                    ...
                                    <div class="sui-col">
                                        <label for="audit_report_day_time"
                                               id="label_audit_report_day_time" class="sui-label">
                                            {{__("Time of day")}}
                                        </label>
                                        <select id="audit_report_day_time"
                                                aria-labelledby="label_audit_report_day_time" class="report-select"
