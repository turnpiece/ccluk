      ...
      <div class="sui-box-body">
        ...
        <div class="sui-box-settings-row">
          <div class="sui-box-settings-col-1">
            ...
            <span
                class="sui-description">{{ __("Specify how many failed login attempts within a specific time period will trigger a lockout.") }}</span>
          </div>
        ...
        <div class="sui-box-settings-row">
          ...
          <div class="sui-box-settings-col-2">
            <sidetab :active="model.login_protection_lockout_ban"
                     @selected="model.login_protection_lockout_ban = $event"
                     slug="login_protection_lockout_ban" :labels="[
                         {
                           text:__('Timeframe'),
                           mute:false,
                           value:false
            ...
            >
              <template v-slot:false>
                <div class="sui-row">
                  <div class="sui-col-md-3">
                    <label for="login_protection_lockout_duration" id="label_login_protection_lockout_duration"
                  ...
                  <div class="sui-col-md-4">
                    <label for="lockout-duration-unit" id="label_lockout_duration_unit"
                           class="sui-label">&nbsp;</label>
                    <select id="lockout-duration-unit"
                            aria-labelledby="label_lockout_duration_unit"
                            name="login_protection_lockout_duration_unit"
