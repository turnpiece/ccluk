                    ...
                    <div class="sui-tabs sui-side-tabs">
                        <div class="sui-side-tabs">
                            <div class="sui-tabs-menu">
                                <label for="pi_apache" :class="{'active':current_server==='apache'}" class="sui-tab-item">
                                    <input type="radio" id="pi_apache" v-model="current_server" value="apache"
                                           data-tab-menu="pi_apache-litespeed-box">
                                    {{__("Apache")}}
                                </label>
                                <label for="pi_litespeed" :class="{'active':current_server==='litespeed'}" class="sui-tab-item">
                            ...
                            <div class="sui-tabs-content">
                                <div class="sui-tab-content sui-tab-boxed" :class="{'active':(current_server==='apache' || current_server==='litespeed')}"
                                ...
                                <div class="sui-tab-content sui-tab-boxed" :class="{'active':current_server==='nginx'}"
                                    ...
                                    <p><code>## WP Defender - Prevent information disclosure ##{{misc.nginx_rules}}## WP Defender - End ##</code>
                                    </p>
