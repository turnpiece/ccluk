                    ...
                    <div class="sui-tabs sui-side-tabs">
                        <div class="sui-side-tabs">
                            <div class="sui-tabs-menu">
                                <label for="pv_apache" :class="{'active':current_server==='apache'}" class="sui-tab-item">
                                    <input type="radio" id="pv_apache" v-model="current_server" value="apache"
                                           data-tab-menu="pi_apache-litespeed-box">
                                    {{__("Apache")}}
                                </label>
                                <label for="pv_litespeed" :class="{'active':current_server==='litespeed'}" class="sui-tab-item">
