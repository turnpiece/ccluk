            ...
            <div class="sui-box">
                <div class="sui-box-header sui-flatten sui-content-center sui-spacing-top--60">
                    <figure class="sui-box-banner" aria-hidden="true">
                        <img :src="assetUrl('assets/img/upgrade-presets.svg')">
                    </figure>
                    ...
                    <h3 class="sui-box-title sui-lg" id="waf-modal-label">
                        {{__('Preset configurations are here!')}}
                    </h3>

                    <p class="sui-description">
                        {{__('That’s right folks, you can now save your Defender settings, download them and reapply them on another site in just a few clicks! No more having to repeat setting up Defender on all your new client sites, just upload your config and go.')}}
                    </p>
                    <div class="text-left waf-description">
                        <p class="sui-description how-does-it-work">{{__('Coming soon – Apply presets to multiple sites via The Hub')}}</p>
                        <p class="sui-description">
                            {{__('If you’re a WPMU DEV member you get it one better – all your configs are automatically uploaded and shared across all your sites, ready to be applied whenever you like from either The Hub of the plugin… Boom!')}}
                        </p>
                    </div>
                </div>
