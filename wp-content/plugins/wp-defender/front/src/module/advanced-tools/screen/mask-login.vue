                ...
                <div class="sui-box-settings-row">
                    ...
                    <span class="sui-description">
                        ...
                        <div class="sui-form-field">
                            ...
                            <span class="sui-description">
                                {{__("Users will login at")}} <a :href='misc.new_login_url'>{{misc.new_login_url}}</a>. {{__("Note: Registration and Password Reset emails have hardcoded URLs in them. We will update them automatically to match your new login URL")}}
                            </span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="sui-box-settings-col-2">
                        <label class="sui-toggle">
                            <input role="presentation" type="checkbox" name="redirect_traffic" class="toggle-checkbox"
                                   id="redirect_traffic" v-model="model.redirect_traffic" :true-value="true" :false-value="false"/>
                        ...
                        <div id="redirectTrafficContainer" class="sui-border-frame sui-toggle-content"
                            ...
                            <input type="text" class="sui-form-control" name="redirect_traffic_url"
                                   v-model="model.redirect_traffic_url"/>
                            <span class="sui-description">
                                {{__("Visitors who visit the default login URLs will be redirected to")}} <a
                                    :href="misc.new_login_url">{{misc.new_login_url}}</a>
                            </span>
                        </div>
                    </div>
                </div>
