		...
		<div id="forminator-dashboard-box--create" class="wpmudev-box wpmudev-box--split wpmudev-can--hide">
			...
			<div class="wpmudev-box-header">
				...
				<div class="wpmudev-header--text">
					...
					<h2 class="wpmudev-title"><?php _e( "Create Modules", Forminator::DOMAIN ); ?></h2>
				...
				<div class="wpmudev-header--action">
					...
					<button class="wpmudev-sr-only"><?php _e( "Hide box", Forminator::DOMAIN ); ?></button>
				...
				<?php foreach ( $args ['modules'] as $key => $module ) : ?>
					...
					<div class="wpmudev-split--item">
						...
						<div class="wpmudev-sitem--header">
							...
							<div class="wpmudev-sitem--icon" aria-hidden="true"><?php echo $module->get_icon(); ?></div>

							<h3 class="wpmudev-sitem--title"><?php echo $module->get_name(); ?></h3>
						...
						<div class="wpmudev-sitem--footer">
							...
							<button href="/" class="wpmudev-button wpmudev-button-sm wpmudev-button-ghost wpmudev-open-modal" data-modal="<?php echo $module->get_id(); ?>"><?php echo $module->get_label(); ?></button>
