...
<div>
	...
	<p>
		<?php
			echo wp_kses_post(
				__( '<b>Note</b>: Make sure you run a full backup of your website before updating your PHP version. <a href="https://premium.wpmudev.org/project/snapshot/" target="_blank">Snapshot Pro</a> can help you with this!', 'shipper' )
			);
		?>
	</p>
</div>
