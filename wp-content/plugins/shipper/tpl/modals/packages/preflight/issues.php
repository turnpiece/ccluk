...
<p class="shipper-description" id="<?php echo esc_attr( $main_id ); ?>-description">
	<?php printf( esc_html__( '%s, we’ve uncovered a few potential issues that may affect the package build and migration process. Take a look through them and action what you like. While you can ignore the warnings, you must fix the errors (if any) to continue your migration.', 'shipper' ),
