...
$themes_path  = Shipper_Helper_Fs_Path::get_relpath( get_theme_root() );
$plugins_path = trailingslashit( Shipper_Helper_Fs_Path::get_relpath( WP_PLUGIN_DIR ) );
$media_path   = Shipper_Helper_Fs_Path::get_relpath( trailingslashit( WP_CONTENT_DIR ) . 'uploads/' );
?>
<div class="sui-form-field shipper-file-exclusions">
	<label class="sui-label">
		...
		<div class="shipper-quicklinks">
			<a href="#wordpress-core" data-path="<?php echo esc_attr( $wp_core ); ?>">
				[<?php esc_html_e( 'WordPress Core', 'shipper' ); ?>]
			</a>,
