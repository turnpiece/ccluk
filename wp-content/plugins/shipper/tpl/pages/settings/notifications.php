...
<div class="sui-box shipper-page-settings-notifications">
        ...
        <div class="sui-box-settings-row shipper-no-separator">
            ...
            <div class="sui-box-settings-col-2">
                <div class="shipper-form-item">
                    <label class="sui-toggle" for="shipper-email-notifications">
                        <input type="checkbox" <?php checked( $do_send ); ?> id="shipper-email-notifications"
                ...
                <div
                    class="<?php echo $do_send ? 'wrapper-active' : ''; ?> shipper-notifications-wrapper sui-border-frame sui-toggle-content">
                    ...
                    <button class="sui-button sui-button-ghost shipper-reveal-add" type="button">
                    ...
                    <div class="shipper-notification-options">
                        ...
                        <label for="email-migration-checkbox" class="sui-checkbox">
                            <input id="email-migration-checkbox"
                                value="<?php echo esc_attr( wp_create_nonce( 'shipper_email_fail_only' ) ); ?>"
                                <?php checked( $failure_send ); ?> type="checkbox"
    ...
    <div class="sui-floating-notices">
        <!-- Start: sui-notifications -->
        <div role="alert" id="shipper-recipient-add-notice" class="sui-notice" aria-live="assertive">
        </div>
