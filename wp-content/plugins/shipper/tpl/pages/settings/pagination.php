			...
			<div class="sui-box-settings-row">
				...
				<div class="sui-box-settings-col-2">
					<div class="sui-form-field">
						<label for="shipper-pagination"
						       class="sui-label"><?php esc_html_e( 'Entries per page', 'shipper' ); ?></label>
						<input type="number"
						       id="shipper-pagination"
						       value="<?php echo esc_attr( $per_page ); ?>"
						       name="pagination[<?php echo Shipper_Model_Stored_Options::KEY_PER_PAGE; ?>]"
