			...
			<div class="sui-box-settings-col-2">
				<div class="shipper-form-item">
					<label class="sui-toggle">
						<input type="checkbox" <?php checked( $use_a11n ); ?>
						       id="shipper-use-a11n"
						       name="accessibility[<?php echo Shipper_Model_Stored_Options::KEY_A11N; ?>]"
						       value="1"/>
						<span class="sui-toggle-slider"></span>
					</label>
					<label for="shipper-use-a11n" class="sui-toggle-label">
