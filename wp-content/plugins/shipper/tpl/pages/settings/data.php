		...
		<div class="sui-box-settings-row">
			<div class="sui-box-settings-col-1">
				...
				<p class="sui-description">
					<?php esc_html_e(
						'When you uninstall this plugin, what do you want to do with your settings and data?',
						'shipper'
					); ?>
				</p>
			</div>
				...
				<div class="shipper-form-item">
					...
					<div class="shipper-data-toggles">
						<label data-active="<?php echo esc_attr( $preserve_settings ? 1 : 0 ); ?>">
							<input type="radio"
								<?php checked( $preserve_settings ) ?>
								name="data[<?php
									echo esc_attr( Shipper_Model_Stored_Options::KEY_SETTINGS );
								?>]"
								value="preserve" />
					...
					<div class="shipper-data-toggles">
						<label data-active="<?php echo esc_attr( $preserve_data ? 1 : 0 ); ?>">
							<input type="radio"
								...
								name="data[<?php
									echo esc_attr( Shipper_Model_Stored_Options::KEY_DATA );
								?>]"
								value="preserve" />
						...
						<label data-active="<?php echo esc_attr( $preserve_data ? 0 : 1 ); ?>">
							<input type="radio"
								<?php checked( empty( $preserve_data ) ) ?>
								name="data[<?php
									echo esc_attr( Shipper_Model_Stored_Options::KEY_DATA );
								?>]"
								value="" />
		...
		<div class="sui-box-settings-row">
			...
			<div class="sui-box-settings-col-2">
				<div class="shipper-form-item">
					<button
						data-wpnonce="<?php
							echo esc_attr( wp_create_nonce( 'shipper_reset_settings' ) );
						?>"
