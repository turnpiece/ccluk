<?php
/*
Plugin Name: CCLUK Events
Plugin URI: https://github.com/turnpiece/ccluk
Description: Organise meetings and events - forked from WPMUdev Events+ plugin
Author: Paul Jenkins & WPMU DEV
Text Domain: eab
WDP ID: 249
Version: 1.9.92
Author URI: https://turnpiece.com
*/

/*
Authors - Paul Jenkins, S H Mohanjith (Incsub), Ve Bailovity (Incsub), Ignacio (Incsub), Ashok Kumar Nath (WPMU DEV)
...
class Eab_EventsHub
{
	...
	function wp_enqueue_scripts()
	{
		...
		$script = 'var _eab_data=' . json_encode(
			apply_filters(
				'eab-javascript-public_data',
				array(
