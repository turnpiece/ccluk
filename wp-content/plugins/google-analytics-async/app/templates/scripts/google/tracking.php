...
})(window,document,'script','https://www.google-analytics.com/analytics.js','<?php echo esc_attr( $ga_tag ); ?>');
 ...
 * @since 3.2.0
 */
$load_tracking = apply_filters( 'beehive_google_load_tracking', true );
?>
