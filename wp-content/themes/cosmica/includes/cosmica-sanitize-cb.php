 ...
 */
function cosmica_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function cosmica_sanitize_css( $css ) {
 ...
 */
function cosmica_sanitize_dropdown_pages( $page_id, $setting ) {
 ...
 */
function cosmica_sanitize_email( $email, $setting ) {
 ...
 */
function cosmica_sanitize_hex_color( $hex_color, $setting ) {
	// Sanitize $input as a hex value without the hash prefix.
 ...
 */
function cosmica_sanitize_html( $html ) {
 ...
 */
function cosmica_sanitize_image( $image, $setting ) {
 ...
 */
function cosmica_sanitize_nohtml( $nohtml ) {
 ...
 */
function cosmica_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function cosmica_sanitize_number_range( $number, $setting ) {
 ...
 */
function cosmica_sanitize_select( $input, $setting ) {
 ...
 */
function cosmica_sanitize_url( $url ) {
