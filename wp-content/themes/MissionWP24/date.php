...
<div class="pageContent">
        ...
        <div class="container">
                    ...
                    <?php } ?>
                            ...
                            <h1 class="pageTitle">
                     <?php if ( is_day() ) : ?>
							<?php printf( __( 'Daily Archives: %s', 'mission' ), '<span>' . get_the_date() . '</span>' ); ?>
						<?php elseif ( is_month() ) : ?>
							<?php printf( __( 'Monthly Archives: %s', 'mission' ), '<span>' . get_the_date( 'F Y' ) . '</span>' ); ?>
						<?php elseif ( is_year() ) : ?>
							<?php printf( __( 'Yearly Archives: %s', 'mission' ), '<span>' . get_the_date( 'Y' ) . '</span>' ); ?>
						<?php else : ?>
							<?php _e( 'Blog Archives', 'mission' ); ?>
						<?php endif; ?></h1>
