        ...
        <div class="container">
                    ...
                    <?php } ?>
                            ...
                            <h1 class="pageTitle">
                                ...
                                <?php printf( __( 'Author Archives %s', 'mission' ), '<span class="vcard"><a class="url fn n" href="' . esc_url( get_author_posts_url( get_the_author_meta( "ID" ) ) ) . '" title="' . esc_attr( get_the_author() ) . '" rel="me">' . get_the_author() . '</a></span>' ); ?>
...
?>                  
                            ...
                            <div style="display: none;"><?php wp_link_pages(); ?> (I use my own pagination)s</div>
