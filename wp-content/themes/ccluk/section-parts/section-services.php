<?php
$id       = get_theme_mod('ccluk_services_id', esc_html__('services', 'ccluk'));
$disable  = get_theme_mod('ccluk_services_disable') == 1 ? true : false;
$title    = get_theme_mod('ccluk_services_title', esc_html__('Our Services', 'ccluk'));
$subtitle = get_theme_mod('ccluk_services_subtitle', esc_html__('Section subtitle', 'ccluk'));
// Get data
    ...
    <?php if (!$disable) : ?>
        <?php if (! ccluk_is_selective_refresh()) { ?>
            <section id="<?php if ($id != '') {
                                echo esc_attr($id);
                            } ?>" <?php do_action('ccluk_section_atts', 'services'); ?> class="<?php echo esc_attr(apply_filters('ccluk_section_class', 'section-services section-padding section-meta onepage-section', 'services')); ?>"><?php } ?>
