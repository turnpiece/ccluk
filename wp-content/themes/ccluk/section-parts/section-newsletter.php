...
$id         = get_theme_mod($slug . '_id', esc_html__('newsletter', 'ccluk'));
$form       = get_theme_mod('ccluk_newsletter_signup_form');
//$title      = get_theme_mod( $slug.'_title', sprintf( __('Signup for our newsletter', 'ccluk' ), get_bloginfo('name') ) );
                ...
                <div class="intro list-item">
                    ...
                    <?php if ($privacy_text && $privacy_page) : ?>
                        <p class="privacy-policy">
                            <a href="<?php echo get_permalink($privacy_page) ?>" title="<?php esc_attr_e('Our privacy policy', 'ccluk') ?>"><?php echo $privacy_text ?></a>
                        </p>
                    <?php endif; ?>
                </div>
            <?php endif; ?>
