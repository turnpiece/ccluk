<?php
$id       = get_theme_mod('ccluk_team_id', esc_html__('team', 'ccluk'));
$disable  = get_theme_mod('ccluk_team_disable') ==  1 ? true : false;
$title    = get_theme_mod('ccluk_team_title', esc_html__('Our Team', 'ccluk'));
$subtitle = get_theme_mod('ccluk_team_subtitle', esc_html__('Section subtitle', 'ccluk'));
    ...
    <?php if (! $disable) : ?>
        <?php if (! ccluk_is_selective_refresh()) { ?>
            <section id="<?php if ($id != '') {
                                echo esc_attr($id);
                            }; ?>" <?php do_action('ccluk_section_atts', 'team'); ?>
