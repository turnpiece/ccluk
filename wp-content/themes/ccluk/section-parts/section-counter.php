<?php
$id       = get_theme_mod('ccluk_counter_id', esc_html__('counter', 'ccluk'));
$disable  = get_theme_mod('ccluk_counter_disable') == 1 ? true : false;
$title    = get_theme_mod('ccluk_counter_title', esc_html__('Our Numbers', 'ccluk'));
$subtitle = get_theme_mod('ccluk_counter_subtitle', esc_html__('Section subtitle', 'ccluk'));
