    ...
    function _the_editor( container ){
        var _editor = {
            ready: function( container ) {
                ...
                control.container.addClass( 'ccluk-editor-added' );
...
jQuery( window ).ready( function( $ ){
    ...
    if ( typeof onepress_customizer_settings !== "undefined" ) {
        ...
        if ( onepress_customizer_settings.is_plus_activated !== 'y' ) {
            ...
            $( '#accordion-section-onepress_order_styling > .accordion-section-title').append( '<span class="ccluk-notice">Plus</span>' );
        }
    }
