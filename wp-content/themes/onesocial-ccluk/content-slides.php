...
if ( onesocial_get_option( 'boss_slider_switch' ) && is_array( $slides ) && !empty( $slides[ 0 ][ 'attachment_id' ] ) ) {
	?>
				...
				<div class="bb-slide">
					...
					<div class="slide_content">
						<div class="slide_content_wrap">
							<div class="inner">
							<?php if (!empty( $url ) && empty( $button_text )) : ?><a class="slide_text" href="<?php echo esc_url( $url ); ?>"<?php echo $target_window; ?>><?php else : ?><div class="slide_text"><?php endif; ?>
								<!-- display Title -->
								...
								if ( !empty( $url ) && !empty( $button_text ) ) :
									?>
									<p class="readmore">
										<a href="<?php echo esc_url( $url ); ?>"<?php echo $target_window; ?> class="button"><?php echo esc_html( $button_text ); ?></a>
									</p>
								<?php endif; ?>
							<?php if (!empty( $url ) && empty( $button_text )) : ?></a><?php else : ?></div><?php endif; ?>
							</div>
						</div>
					</div>
