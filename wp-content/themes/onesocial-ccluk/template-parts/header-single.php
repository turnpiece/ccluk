				...
				<div class="container">
					<div class="inner">
						<?php if (is_singular('post')) :
							...
							printf('<span class="authors-avatar vcard table-cell"><a class="url fn n" href="%1$s" title="%2$s" rel="author">%3$s</a></span>', $user_link, esc_attr(sprintf(__('View all posts by %s', 'ccluk'), $author_name)), get_avatar($author_id, 85, '', $author_name));
						...
						<div class="details table-cell">
							<?php if (is_singular('post')) :
								...
								printf(
									'<span class="author-name vcard"><a class="url fn n" href="%1$s" title="%2$s" rel="author">%3$s</a></span>',
									$user_link,
									esc_attr(sprintf(__('View all posts by %s', 'ccluk'), $author_name)),
									$author_name
								);
