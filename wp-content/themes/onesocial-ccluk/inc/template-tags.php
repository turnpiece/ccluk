...
if ( ! function_exists( 'ccluk_hex_to_rgba' ) ) {
    /**
     ...
     * @return bool|string
     */
    function ccluk_hex_to_rgba( $color, $alpha = 1)
    {
...
add_action( 'wp_enqueue_scripts', 'ccluk_custom_inline_style', 100 );
if ( ! function_exists( 'ccluk_custom_inline_style' ) ) {
    /**
     * Add custom css to header
     *
     * @change 1.1.5
     */
	function ccluk_custom_inline_style( ) {

            /**
             *  Custom hero section css
             */
            $hero_bg_color = get_theme_mod( 'ccluk_hero_overlay_color', '#000000' );

            // Deprecate form v 1.1.5
            $hero_bg_color = ccluk_hex_to_rgba( $hero_bg_color, get_theme_mod( 'ccluk_hero_overlay_opacity' , .3 ) );
             ...
             * Header background
             */
            $header_bg_color =  get_theme_mod( 'ccluk_header_bg_color' );
            if ( $header_bg_color ) {
                ?>
                .site-header {
             ...
             */
            $menu_hover_bg =  get_theme_mod( 'ccluk_menu_hover_bg_color' );
            if ( $menu_hover_bg ) {
                ?>
             ...
             */
            $menu_button_color =  get_theme_mod( 'ccluk_menu_toggle_button_color' );
             ...
             * Site Title
             */
            $ccluk_logo_text_color =  get_theme_mod( 'ccluk_logo_text_color' );
            if ( $ccluk_logo_text_color ) {
                ?>
				.site-branding .site-title, .site-branding .site-text-logo {
					color: #<?php echo $ccluk_logo_text_color; ?>;
				}
            <?php
            }

            $ccluk_footer_bg = get_theme_mod( 'ccluk_footer_bg' );
            if ( $ccluk_footer_bg ) {
                ?>
                .site-footer {
                    background-color: #<?php echo $ccluk_footer_bg; ?>;
                }
            ...
            $ccluk_footer_info_bg = get_theme_mod( 'ccluk_footer_info_bg' );
            if ( $ccluk_footer_info_bg ) {
                ?>
                .site-footer .site-info, .site-footer .btt a{
                    background-color: #<?php echo $ccluk_footer_info_bg; ?>;
                }
        ...
        $custom = get_option( 'ccluk_custom_css' );
        if ( $custom ){
            $css.= "\n/* --- Begin custom CSS --- */\n". $custom."\n/* --- End custom CSS --- */\n";
        }

        wp_add_inline_style( 'ccluk-style', $css );
	}
