...
class CCLUK_Newletter_Signup extends WP_Widget {
    ...
    public function widget( $args, $instance ) {
        ...
        echo esc_html__( $instance['text'], 'onesocial' );

        echo $this->signup_form;

        if ($this->privacy_page && $instance['privacy']) : ?>
            <p class="privacy-policy">
                <a href="<?php echo get_permalink( $this->privacy_page ) ?>" title="<?php esc_attr_e( 'Our privacy policy', 'onesocial' ) ?>"><?php echo $instance['privacy'] ?></a>
            </p>    
        <?php endif;
    ...
    public function form( $instance ) {
        ...
        $title = ! empty( $instance['title'] ) ? $instance['title'] : esc_html__( '', 'onesocial' );
        $text = ! empty( $instance['text'] ) ? $instance['text'] : esc_html__( '', 'onesocial' );
        $privacy = ! empty( $instance['privacy'] ) ? $instance['privacy'] : esc_html__( '', 'onesocial' );
        ?>
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php esc_attr_e( 'Title:', 'onesocial' ); ?></label>
