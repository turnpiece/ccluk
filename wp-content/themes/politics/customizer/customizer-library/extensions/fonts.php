...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'politics' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'politics' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'politics' ),
		'cyrillic'     => __( 'Cyrillic', 'politics' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'politics' ),
		'devanagari'   => __( 'Devanagari', 'politics' ),
		'greek'        => __( 'Greek', 'politics' ),
		'greek-ext'    => __( 'Greek Extended', 'politics' ),
		'khmer'        => __( 'Khmer', 'politics' ),
		'latin'        => __( 'Latin', 'politics' ),
		'latin-ext'    => __( 'Latin Extended', 'politics' ),
		'vietnamese'   => __( 'Vietnamese', 'politics' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'politics' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'politics' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'politics' ),
